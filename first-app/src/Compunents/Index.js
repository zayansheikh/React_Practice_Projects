          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="block-7">
              <div class="text-center">
                ...
                <span class="price">
                  <sup>$</sup> <span class="number">49</span> <sub>/mos</sub>
                </span>

                <ul class="pricing-text mb-5">
                  <li>
                    <span class="fa fa-check mr-2"></span>Brand Strategy
                  </li>
                  <li>
                    <span class="fa fa-check mr-2"></span>Online Marketing
                  </li>
                  <li>
                    <span class="fa fa-check mr-2"></span>Branding Services
                  </li>
                  <li>
                    <span class="fa fa-check mr-2"></span>Creative Marketing
                  </li>
                  <li>
                    <span class="fa fa-check mr-2"></span>Sales Management
                  </li>
                </ul>
          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="block-7">
              <div class="text-center">
                ...
                <span class="price">
                  <sup>$</sup> <span class="number">79</span> <sub>/mos</sub>
                </span>
          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="block-7">
              <div class="text-center">
                ...
                <span class="price">
                  <sup>$</sup> <span class="number">109</span> <sub>/mos</sub>
                </span>
          ...
          <div class="col-md-6 col-lg-3 ftco-animate">
            <div class="block-7">
              <div class="text-center">
                ...
                <span class="price">
                  <sup>$</sup> <span class="number">149</span> <sub>/mos</sub>
                </span>
